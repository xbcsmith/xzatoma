/// ACP event models.
///
/// This module intentionally re-exports the canonical ACP event domain types
/// from `crate::acp::types` so the ACP surface stays coherent across the crate.
/// Phase 1 uses `types.rs` as the single source of truth for protocol-facing ACP
/// events, event kinds, and timestamp helpers.
///
