...
We should be able to configure what models and provider are used for subagents. This includes the ability to specify the model, provider, and any additional parameters required for the subagent. This should be configurable through a configuration file or environment variables or flags passed to the CLI. For example if I am using the copilot provider with the gpt-5.3-codex model and I want to use the gpt-5.3-codex model for the subagent, I can specify the following configuration:
