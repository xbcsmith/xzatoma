...
Subcommands:
- `xzatoma models list [--provider <name>]` — list available models, optionally filtered by provider
- `xzatoma models info --model <id> [--provider <name>]` — show detailed information about a specific model
