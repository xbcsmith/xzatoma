...
- [Quickstart Tutorial](tutorials/quickstart.md) _(coming soon)_ - Get started with your first documentation generation
...
- [Design Decisions](explanation/design_decisions.md) _(coming soon)_ - Why we made certain choices
...
- [CLI Reference](reference/cli.md) _(coming soon)_ - Command-line interface documentation
- [Configuration Reference](reference/configuration.md) _(coming soon)_ - All configuration options
- [Workflow Format](reference/workflow_format.md) _(coming soon)_ - Workflow file specification
- [API Reference](reference/api.md) _(coming soon)_ - Library API documentation

## Quick Navigation

### I want to...

- **Get started quickly** → [Quickstart Tutorial](tutorials/quickstart.md) _(coming soon)_
...
- No emojis in content (only in this index for navigation)
